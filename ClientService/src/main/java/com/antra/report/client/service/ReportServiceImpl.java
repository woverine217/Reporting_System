...
//import com.antra.report.client.repository.ExcelReportRepo;
//import com.antra.report.client.repository.PDFReportRepo;
...
public class ReportServiceImpl implements ReportService {
    ...
    public void sendDirectRequests(ReportRequest request) {
...
//    @Transactional // why this? email could fail
    public void updateAsyncPDFReport(SqsResponse response) {
        ...
        String to = "albertwang217@gmail.com";
...
//        }
    ...
    @Override
    public void deleteFileBodyByReqId(String reqId) {
        ReportRequestEntity entity = reportRequestRepo.findById(reqId).orElseThrow(RequestNotFoundException::new);
        delete(entity.getPdfReport().getFileLocation());
        delete(entity.getExcelReport().getFileLocation());
//        pdfReportRepo.deleteById(entity.getPdfReport().getFileId());
//        excelReportRepo.deleteById(entity.getExcelReport().getFileId());
        reportRequestRepo.deleteById(reqId);


    }
    private void delete(String fileLocation) {
        // this location is s3 "bucket/key"
        String bucket = fileLocation.split("/")[0];
        String key = fileLocation.split("/")[1];
