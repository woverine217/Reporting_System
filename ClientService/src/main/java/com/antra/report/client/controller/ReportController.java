...
public class ReportController {
    ...
    public void deleteFile(@PathVariable String reqId, HttpServletResponse response) throws IOException {
        log.debug("Got Request to delete File - type: {}, reqid: {}", reqId);
        reportService.deleteFileBodyByReqId(reqId);
    }
//   @PutMapping
